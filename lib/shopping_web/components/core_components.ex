defmodule ShoppingWeb.CoreComponents do
  ...
  attr(:class, :string,
    default: nil,
    doc: "Extra classes. Only implemented for text and similar so far"
  )
  ...
  attr(:extra_row_class_fn, :any,
    default: nil,
    doc: "takes a row item and appends any extra classes"
  )
    ...
    <div class="px-4 sm:overflow-visible sm:px-0 ">
      <table class={["w-full sm:w-full", @extra_class]}>
        <thead class="text-sm text-left leading-6 text-zinc-500">
          <tr>
            <th :for={col <- @col} class={["p-0 pr-6 pb-4 font-normal", col[:extra_class]]}>
              <%= col[:label] %>
            </th>
        ...
        >
          <tr
            ...
            class={["group hover:bg-zinc-50", row |> @row_item.() |> @extra_row_class_fn.()]}
          >
            <td
